...
const coffees = [
  {
    ...
    coffee_thumbnails: `${BASE_URL}/images/caffe_latte_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/caffe_latte_poster.jpg`
  },
  {
    coffee_id: 2,
    coffee_title: "Cappuccino",
    coffee_detail: "Espresso with steamed milk, topped with a deep layer of foam.",
    coffee_thumbnails: `${BASE_URL}/images/cappuccino_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/cappuccino_poster.jpg`
  },
  {
    coffee_id: 3,
    ...
    coffee_thumbnails: `${BASE_URL}/images/caffe_mocha_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/caffe_mocha_poster.jpg`
  },
  {
    coffee_id: 4,
    ...
    coffee_thumbnails: `${BASE_URL}/images/caramel_macchiato_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/caramel_macchiato_poster.jpg`
  },
  {
    coffee_id: 5,
    ...
    coffee_thumbnails: `${BASE_URL}/images/vanilla_sweet_cream_cold_brew_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/vanilla_sweet_cream_cold_brew_poster.jpg`
  },
  {
    coffee_id: 6,
    ...
    coffee_thumbnails: `${BASE_URL}/images/cold_brew_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/cold_brew_poster.jpg`
  },
  {
    coffee_id: 7,
    ...
    coffee_thumbnails: `${BASE_URL}/images/mango_passion_frappuccino_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/mango_passion_frappuccino_poster.jpg`
  },
  {
    coffee_id: 8,
    coffee_title: "Raspberry Currant Frappuccino",
    coffee_detail: "Made with freshly brewed Teavana® tea, blended juice and ice.",
    coffee_thumbnails: `${BASE_URL}/images/raspberry_currant_frappuccino_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/raspberry_currant_frappuccino_poster.jpg`
  },
  {
    coffee_id: 9,
    ...
    coffee_thumbnails: `${BASE_URL}/images/coffee_frappuccino_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/coffee_frappuccino_poster.jpg`
  },
  {
    coffee_id: 10,
    ...
    coffee_thumbnails: `${BASE_URL}/images/mocha_frappuccino_thumbnail.png`,
    coffee_poster: `${BASE_URL}/images/mocha_frappuccino_poster.jpg`
  }
];
